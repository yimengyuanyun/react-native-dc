...
export const commentAddThemeObj = (objCid, openFlag, commentSpace) => {
  return new Promise((resolve) => {
...
export const commentAddThemeSpace = (objCid, commentSpace) => {
  return new Promise((resolve) => {
    const successCallback = (res) => {
...
export const commentDisableTheme = (objCid) => {
  return new Promise((resolve) => {
    const successCallback = (res) => {
