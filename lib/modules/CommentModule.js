...
export const comment_AddCommentableObj = (objCid, openFlag, commentSpace) => {
  return new Promise((resolve) => {
...
export const comment_AddObjCommentSpace = (objCid, commentSpace) => {
  return new Promise((resolve) => {
    const successCallback = (res) => {
...
export const comment_DisableCommentObj = (objCid) => {
  return new Promise((resolve) => {
    const successCallback = (res) => {
...
export const comment_DeleteSelfComment = (objCid, objAuthor, commentKey) => {
  return new Promise((resolve) => {
    const successCallback = (bool) => {
