...
// 获取节点状态
export const DCpeerState = (multiaddr: string) => {
  return new Promise((resolve, reject) => {
    const successCallback = (state: string) => {
...
export const DCgetStroagePrices = () => {
  return new Promise(resolve => {
    const successCallback = (jsonStroragePrices: string) => {
...
// 购买存储
export const DCsubscribeStorage = (pricetype: number) => {
  return new Promise(resolve => {
